...
const About = () => {
    return (
        <div id='about' className='flex flex-col xl:flex-row justify-center items-center gap-8 px-6 py-24'>
            ...
            <div className='w-[fit-content] max-w-[740px]'>
                <h1 className='text-3xl lg:text-5xl font-semibold mb-6'>FREE Online Pediatrician community which is available 24x7</h1>
                <p className='text-lg'>Babynama is an online platform where you get instant access to India’s trusted pediatricians at absolutely any time of the day with any concern regarding your baby, and get guaranteed responses within 10 minutes!</p>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-8'>
                    <div className='flex items-center gap-2 w-full max-w-[320px] sm:w-[320px] border-2 border-[#b2f0fb] rounded-lg'>
                        <div className='p-2 rounded-lg rounded-tr-full rounded-br-full bg-[#e4f5f8]'>
                            <svg enableBackground="new 0 0 512 512" height="50" viewBox="0 0 512 512" width="50" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex items-center gap-2 w-full max-w-[320px] sm:w-[320px] border-2 border-[#ffbdbc] rounded-lg'>
                        ...
                        <div>
                            <p className='text-md font-semibold'>TRUSTED PEDIATRICIANS & NUTRITIONISTS</p>
                        </div>
                    </div>
