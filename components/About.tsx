...
const About = () => {
  return (
    <div
      id="about"
      className="relative flex flex-col xl:flex-row justify-center items-center gap-8 px-6 py-24"
    >
      <img
        className="absolute animate-bounce right-20 top-8 sm:top-20"
        src="images/shap/circle-dots.webp"
        alt=""
      />
      <img
        className="absolute animate-rotate right-40 bottom-8 sm:bottom-20"
        src="images/shap/plus-orange.webp"
        alt=""
      />
      <img
        ...
        alt=""
      />
      <div className="relative z-1 flex flex-col gap-4 xl:w-[470px] mr-12">
        <div className="flex items-end gap-4">
          {/* <img className='w-[200px] rounded-tr-3xl rounded-b-3xl ' src="/images/about/pic-1.webp" alt="" /> */}
          <div className="w-full sm:w-[200px]">
            <Image
              className="rounded-tr-3xl rounded-b-3xl"
              src={pic1}
              loading="lazy"
            />
          </div>
          <div className="w-full sm:w-[250px]">
            <Image
              className="rounded-b-3xl rounded-tl-3xl"
              src={pic2}
              loading="lazy"
            />
          </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="bg-[#a0d9ef] py-8 sm:py-16 px-2 w-fit h-fit sm:w-[200px] sm:h-[230px] flex flex-col items-start pl-6 sm:pl-12 justify-center rounded-bl-3xl rounded-t-3xl">
            <p className="sm:text-5xl text-[22px] font-semibold">30+</p>
            <p className="sm:text-xl text-[14px] font-medium">Pediatricians</p>
          </div>
        </div>
      </div>
      <div className="relative z-1 w-[fit-content] max-w-[740px]">
        <h1 className="text-3xl lg:text-5xl font-semibold mb-6">
          Online Pediatrician community which is available 24x7
        </h1>
        <p className="text-lg">
          Babynama is an online platform where you get instant access to India’s
          trusted pediatricians at absolutely any time of the day with any
          concern regarding your baby, and get guaranteed responses within 10
          minutes
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <div className="flex items-center gap-2 w-full max-w-[320px] sm:w-[320px] border-2 border-[#b2f0fb] rounded-lg">
            <div className="p-2 rounded-lg rounded-tr-full rounded-br-full bg-[#e4f5f8]">
              <svg
            ...
            <div>
              <p className="text-md font-semibold">INSTANT ANSWERS IN 10 MIN</p>
            </div>
          </div>
          <div className="flex items-center gap-2 w-full max-w-[320px] sm:w-[320px] border-2 border-[#a4fcc4] rounded-lg">
            <div className="p-2 rounded-tr-full rounded-br-full bg-[#d5fde4]">
              <svg
                enableBackground="new 0 0 512 512"
                height="50"
                viewBox="0 0 512 512"
            ...
            <div>
              <p className="w-full text-md font-semibold">24x7 AVAILABILITY</p>
            </div>
          </div>
          <div className="flex items-center gap-2 w-full max-w-[320px] sm:w-[320px] border-2 border-[#ffbdbc] rounded-lg">
            <div className="p-2 rounded-tr-full rounded-br-full bg-[#fae2e1]">
              <svg
                enableBackground="new 0 0 512 512"
                height="50"
                viewBox="0 0 512 512"
            ...
            <div>
              <p className="text-md font-semibold">
                TRUSTED PEDIATRICIANS & NUTRITIONISTS
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2 w-full max-w-[320px] sm:w-[320px] border-2 border-[#020288] rounded-lg">
            <div className="p-2 rounded-tr-full rounded-br-full bg-[#ededfc]">
              <svg
                enableBackground="new 0 0 512 512"
                height="50"
                viewBox="0 0 512 512"
            ...
            <div>
              <p className="text-md font-semibold">ONLINE CONSULTATIONS</p>
            </div>
          </div>
        </div>
      </div>
